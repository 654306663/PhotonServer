...
namespace Net
{
    public class EventMediat
    {
        ...
        static Dictionary<EventCode, Delegate> messageTable = new Dictionary<EventCode, Delegate>();
        ...
        public static void AddListener(EventCode type, Act act)
        {
        ...
        /// <param name="type"></param>
        /// <param name="act"></param>
        public static void RemoveListener(EventCode type, Act act)
        {
            if (messageTable.ContainsKey(type))
            {
                Delegate d = messageTable[type];
        ...
        public static void Dispatch(EventCode type, EventData param)
        {
            Delegate d;
        ...
        /// </summary>
        /// <param name="type"></param>
        public static void RemoveAllListener(EventCode type)
        {
            if (messageTable.ContainsKey(type))
            {
